...
| 9     | Ask to buy, order conversation    | in progress |                                         | Rescoped 2026-08-07: no card checkout. create_order RPC built and verified. Nothing wired to it yet: no Ask to buy button or action.                                                                                                                                                                                                                                                                                                                                        |
| 9b    | Payment links and marking paid    | not started |                                         | Added 2026-08-07 by the same plan change.                                                                                                                                                                                                                                                                                                                                                                                                        |
| 10    | Orders, email, fulfilment         | not started |                                         |                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 11    | Chat                              | in progress | feat/chat-ui                            | Built 2026-08-20: buyer /messages page with sign in wall and intent, owner /admin/messages inbox and thread, canned replies, payment link form, payment-link and delivery-details cards. Verified over real HTTP with a real buyer session: text accepted 201, a buyer faking a payment_link refused by the trigger, every card type rendered. NOT built: Realtime subscription, optimistic send, image attachments, the delivery details Dialog, and the floating widget. Those are the rest of the stage.                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
