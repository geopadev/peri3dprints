...
Current stage: 5b done, 11 part built
Current branch: main
...
| 11    | Chat                              | in progress | feat/chat (merged)                      | Data layer, schemas, migrations, RLS and the payment-link guard trigger are done and verified. No UI: no buyer widget, no owner inbox, no payment-link card, no delivery dialog.                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
